...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post managers_url, params: { manager: { manager_email: @manager.manager_email, manager_pw: @manager.manager_pw } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { manager_email: @manager.manager_email, manager_pw: @manager.manager_pw } }
